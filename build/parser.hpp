...
/**
 ** \file /home/etud/Bureau/compilation/build/parser.hpp
...
#ifndef YY_YY_HOME_ETUD_BUREAU_COMPILATION_BUILD_PARSER_HPP_INCLUDED
# define YY_YY_HOME_ETUD_BUREAU_COMPILATION_BUILD_PARSER_HPP_INCLUDED
...
#line 63 "/home/etud/Bureau/compilation/build/parser.hpp"
...
namespace yy {
#line 197 "/home/etud/Bureau/compilation/build/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    NL = 258,                      // NL
    END = 259,                     // END
    RECTANGLE = 260,               // RECTANGLE
    CARRE = 261,                   // CARRE
    TRIANGLE = 262,                // TRIANGLE
    CERCLE = 263,                  // CERCLE
    ELLIPSE = 264,                 // ELLIPSE
    LIGNE = 265,                   // LIGNE
    CHEMIN = 266,                  // CHEMIN
    ...
    STRING = 269,                  // STRING
    FLECHE = 270,                  // FLECHE
    REMPLISSAGE = 271,             // REMPLISSAGE
    COULEUR = 272,                 // COULEUR
    EPAISSEUR = 273,               // EPAISSEUR
    ROTATION = 274,                // ROTATION
    OPACITE = 275,                 // OPACITE
    BOOL = 276,                    // BOOL
    FLOTTANT = 277,                // FLOTTANT
    TAILLE = 278,                  // TAILLE
    LONGUEUR = 279,                // LONGUEUR
    HAUTEUR = 280,                 // HAUTEUR
    X = 281,                       // X
    Y = 282,                       // Y
    X1 = 283,                      // X1
    ...
    REPETE = 317,                  // REPETE
    FOIS = 318,                    // FOIS
    FONCTION = 319,                // FONCTION
    COULEURG = 320,                // COULEURG
    NEG = 321                      // NEG
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_NL = 3,                                // NL
        S_END = 4,                               // END
        S_RECTANGLE = 5,                         // RECTANGLE
        S_CARRE = 6,                             // CARRE
        S_TRIANGLE = 7,                          // TRIANGLE
        S_CERCLE = 8,                            // CERCLE
        S_ELLIPSE = 9,                           // ELLIPSE
        S_LIGNE = 10,                            // LIGNE
        S_CHEMIN = 11,                           // CHEMIN
        ...
        S_STRING = 14,                           // STRING
        S_FLECHE = 15,                           // FLECHE
        S_REMPLISSAGE = 16,                      // REMPLISSAGE
        S_COULEUR = 17,                          // COULEUR
        S_EPAISSEUR = 18,                        // EPAISSEUR
        S_ROTATION = 19,                         // ROTATION
        S_OPACITE = 20,                          // OPACITE
        S_BOOL = 21,                             // BOOL
        S_FLOTTANT = 22,                         // FLOTTANT
        S_TAILLE = 23,                           // TAILLE
        S_LONGUEUR = 24,                         // LONGUEUR
        S_HAUTEUR = 25,                          // HAUTEUR
        S_X = 26,                                // X
        S_Y = 27,                                // Y
        S_X1 = 28,                               // X1
        S_X2 = 29,                               // X2
        ...
        S_SUPEG = 57,                            // SUPEG
        S_EST = 58,                              // EST
        S_NESTPAS = 59,                          // NESTPAS
        S_AND = 60,                              // AND
        S_WHILE = 61,                            // WHILE
        S_REPETE = 62,                           // REPETE
        S_FOIS = 63,                             // FOIS
        S_FONCTION = 64,                         // FONCTION
        S_COULEURG = 65,                         // COULEURG
        S_66_ = 66,                              // '-'
        S_67_ = 67,                              // '+'
        S_68_ = 68,                              // '*'
        S_69_ = 69,                              // '/'
        ...
        S_main = 87,                             // main
        S_programme = 88,                        // programme
        S_boucle = 89,                           // boucle
        S_COND = 90,                             // COND
        S_instructions = 91,                     // instructions
        S_affectation = 92,                      // affectation
        S_comparaisons = 93,                     // comparaisons
        S_comparaison = 94,                      // comparaison
        S_figures = 95,                          // figures
        S_VAR_COULEUR = 96,                      // VAR_COULEUR
        S_VAR_FIGURE = 97,                       // VAR_FIGURE
        S_figureavecattr = 98,                   // figureavecattr
        S_figuresansattr = 99,                   // figuresansattr
        S_coords = 100,                          // coords
        S_ATTRS1 = 101,                          // ATTRS1
        S_ATTRS2 = 102,                          // ATTRS2
        S_ATTR = 103,                            // ATTR
        S_ENTIER = 104,                          // ENTIER
        S_VAL_COULEUR = 105                      // VAL_COULEUR
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_VAL_COULEUR: // VAL_COULEUR
        value.move< couleur > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, couleur&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const couleur& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_VAL_COULEUR: // VAL_COULEUR
        value.template destroy< couleur > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::TEXTE)
                   || (token::FLECHE <= tok && tok <= token::OPACITE)
                   || (token::TAILLE <= tok && tok <= token::COULEURG)
                   || tok == 45
                   || tok == 43
                   || tok == 42
                   || tok == 47
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_FLOTTANT (double v, location_type l)
      {
        return symbol_type (token::FLOTTANT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_FLOTTANT (const double& v, const location_type& l)
      {
        return symbol_type (token::FLOTTANT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LONGUEUR (location_type l)
      {
        return symbol_type (token::LONGUEUR, std::move (l));
      }
#else
      static
      symbol_type
      make_LONGUEUR (const location_type& l)
      {
        return symbol_type (token::LONGUEUR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_RAYON (location_type l)
      {
        return symbol_type (token::RAYON, std::move (l));
      }
#else
      static
      symbol_type
      make_RAYON (const location_type& l)
      {
        return symbol_type (token::RAYON, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RGB (location_type l)
      {
        return symbol_type (token::RGB, std::move (l));
      }
#else
      static
      symbol_type
      make_RGB (const location_type& l)
      {
        return symbol_type (token::RGB, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_INFEG (location_type l)
      {
        return symbol_type (token::INFEG, std::move (l));
      }
#else
      static
      symbol_type
      make_INFEG (const location_type& l)
      {
        return symbol_type (token::INFEG, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_SUPEG (location_type l)
      {
        return symbol_type (token::SUPEG, std::move (l));
      }
#else
      static
      symbol_type
      make_SUPEG (const location_type& l)
      {
        return symbol_type (token::SUPEG, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_NESTPAS (location_type l)
      {
        return symbol_type (token::NESTPAS, std::move (l));
      }
#else
      static
      symbol_type
      make_NESTPAS (const location_type& l)
      {
        return symbol_type (token::NESTPAS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_COULEURG (location_type l)
      {
        return symbol_type (token::COULEURG, std::move (l));
      }
#else
      static
      symbol_type
      make_COULEURG (const location_type& l)
      {
        return symbol_type (token::COULEURG, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 2436 "/home/etud/Bureau/compilation/build/parser.hpp"




#endif // !YY_YY_HOME_ETUD_BUREAU_COMPILATION_BUILD_PARSER_HPP_INCLUDED
